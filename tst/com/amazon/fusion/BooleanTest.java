...
//            expectContractFailure("("+ops[i]+" 1 "+reallyBigDec+")");
    ...
    @Test
    public void testNewComparisonFail()
        throws Exception
    {
        topLevel().requireModule("/fusion/experimental/compare");
        ...
        for (int i = 0; i < ops.length; i++)
        {
            assertEval(false, "("+ops[i]+" 1 true)");
            assertEval(false, "("+ops[i]+" 1 \"hello\")");
            assertEval(false, "("+ops[i]+" 1 2008-08-28)");
            assertEval(false, "("+ops[i]+" 1 2007-08-28T16:37:24.0000Z)");
            assertEval(false, "("+ops[i]+" 1 (void))");
//            expectContractFailure("("+ops[i]+" 1 1.667)");
//            expectContractFailure("("+ops[i]+" 1 "+reallyBigDec+")");

            assertEval(false, "("+ops[i]+" true 1)");
            assertEval(false, "("+ops[i]+" true \"hello\")");
            assertEval(false, "("+ops[i]+" true 2008-08-28)");
            assertEval(false, "("+ops[i]+" true 2007-08-28T16:37:24.0000Z)");
            assertEval(false, "("+ops[i]+" true (void))");
            assertEval(false, "("+ops[i]+" true 1.667)");
            assertEval(false, "("+ops[i]+" true "+reallyBigNumber+")");
            assertEval(false, "("+ops[i]+" true "+reallyBigDec+")");

            assertEval(false, "("+ops[i]+" \"hello\" 1)");
            assertEval(false, "("+ops[i]+" \"hello\" true)");
            assertEval(false, "("+ops[i]+" \"hello\" 2008-08-28)");
            assertEval(false, "("+ops[i]+" \"hello\" 2007-08-28T16:37:24.0000Z)");
            assertEval(false, "("+ops[i]+" \"hello\" (void))");
            assertEval(false, "("+ops[i]+" \"hello\" 1.667)");
            assertEval(false, "("+ops[i]+" \"hello\" "+reallyBigNumber+")");
            assertEval(false, "("+ops[i]+" \"hello\" "+reallyBigDec+")");

            assertEval(false, "("+ops[i]+" 2008-08-28 1)");
            assertEval(false, "("+ops[i]+" 2008-08-28 \"hello\")");
            assertEval(false, "("+ops[i]+" 2008-08-28 true)");
            assertEval(false, "("+ops[i]+" 2008-08-28 (void))");
            assertEval(false, "("+ops[i]+" 2008-08-28 1.667)");
            assertEval(false, "("+ops[i]+" 2008-08-28 "+reallyBigNumber+")");
            assertEval(false, "("+ops[i]+" 2008-08-28 "+reallyBigDec+")");

            assertEval(false, "("+ops[i]+" 2007-08-28T16:37:24.0000Z true)");
            assertEval(false, "("+ops[i]+" 2007-08-28T16:37:24.0000Z 1)");
            assertEval(false, "("+ops[i]+" 2007-08-28T16:37:24.0000Z \"hello\")");
            assertEval(false, "("+ops[i]+" 2008-08-28T16:37:24.0000Z (void))");
            assertEval(false, "("+ops[i]+" 2008-08-28T16:37:24.0000Z 1.667)");
            assertEval(false, "("+ops[i]+" 2008-08-28T16:37:24.0000Z "+reallyBigNumber+")");
            assertEval(false, "("+ops[i]+" 2008-08-28T16:37:24.0000Z "+reallyBigDec+")");
        }
    }
}
